document.addEventListener("DOMContentLoaded", function () {
  ...
  function init() {
    ...
    function initNavbarUser() {
      ...
      function updateButtons() {
        ...
        <img src="${user.photo || "assets/img/icons/user.png"}" 
             alt="Profile" class="btn-icon profile-icon"/>
    ...
    `;
      ...
      // Make global so login.js can call after login/signup
    ...
    completeBooking.addEventListener("click", function () {
      ...
      (async () => {
        ...
        try {
          ...
          if (res.ok) {
            showToast(`${selectedProduct} added to your cart!`, "success");
